-- Extracted from:
-- D:\borislavRieltor\db_cluster-13-12-2025@17-37-13.backup
--
-- This file keeps only the portable public schema/data that actually exist
-- in the Supabase dump and can be imported into plain PostgreSQL.
